...
const MediaImageDialog = ({ isOpen, onClose, selectedImage, isLoading, handleSendImage }) => {
...
const MediaVideoDialog = ({ isOpen, onClose, selectedVideo, isLoading, handleSendVideo }) => {
